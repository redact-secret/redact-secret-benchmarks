...
import { validateAssessment, classifyFixture, validateContracts } from '../lib/assessment.mjs';
import { validateStructures } from '../lib/validate-structures.mjs';
import { hash, secrets } from './model.mjs';

const root = fileURLToPath(new URL('../../', import.meta.url));
const taxonomy = (category, f) => {
...
export async function loadCases(operators) {
  validateContracts();
  ...
  const generated = buildCorpora(), cases = [];
