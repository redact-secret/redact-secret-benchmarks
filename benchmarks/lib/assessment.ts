...
export const contracts: Record<string, FormatContract> = {
  ...
  'vercel-token': { tier: 'T0', corroboration: [th('vercel/vercel')], review: 'Vercel REST API documentation does not describe token prefixes. The pinned detector uses contextual 24-character tokens, not the five vcp_/vci_/vca_/vcr_/vck_ shapes in the corpus. Pending.', unprobeable: unprobeable('The positive is T0 pending, and the Vercel REST API reference states no token prefix, length or alphabet. Nothing documented to mutate and no scored positive to pair against.') },
