...
This is a diff against [`docs/specs/evaluation-engine-v1.md`](evaluation-engine-v1.md)
...
Every comparison surface — `docs/generated/release-comparison.md`, the baselines, the
...
v1.1 and the baselines regenerated. Until then, `docs/generated/release-comparison.md`
