...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| `size/cli/aarch64-unknown-linux-gnu` | regression | 863848 | 930576 | +7.7% | 43192.400 bytes | breach without an accepted tradeoff in benchmarks/accepted-regressions.json |
