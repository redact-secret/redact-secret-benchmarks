# Evidence: redact-secret#815 — fixed-candidate rerun of its beta9-external-inputs fixtures

**Result:** PASS. On the fixed candidate `192c964` all 4 of this gap's
...
Gap: [redact-secret#815](https://github.com/redact-secret/redact-secret/issues/815),
...
| --- | --- | --- | --- |
| `beta9-external-inputs--composed-json-string-in-json-log` | must-redact | missed | redacted |
| `beta9-external-inputs--ds-keyword-template-chars-in-secret` | must-redact | missed | redacted |
| `beta9-external-inputs--ds-keyword-go-short-assign` | must-redact | missed | redacted |
| `beta9-external-inputs--ds-objc-at-string` | must-redact | missed | redacted |
