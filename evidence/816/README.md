# Evidence: redact-secret#816 — fixed-candidate rerun of its beta9-external-inputs fixtures

**Result:** PASS. On the fixed candidate `192c964` all 7 of this gap's
`beta9-external-inputs` fixtures report exactly the expected range (first run: missed, partial),
and none of the pack's 80 fixtures regressed from the first run.

Gap: [redact-secret#816](https://github.com/redact-secret/redact-secret/issues/816),
...
| --- | --- | --- | --- |
| `beta9-external-inputs--rfc6750-query-access-token` | must-redact | missed | redacted |
| `beta9-external-inputs--rfc6750-get-request-line` | must-redact | missed | redacted |
| `beta9-external-inputs--rfc6749-implicit-fragment-display-break` | must-redact | missed | redacted |
| `beta9-external-inputs--rfc6749-authorization-code-location` | must-redact | missed | redacted |
| `beta9-external-inputs--rfc7636-code-verifier` | must-redact | missed | redacted |
| `beta9-external-inputs--rfc6749-refresh-request-body` | must-redact | missed | redacted |
| `beta9-external-inputs--rfc6749-token-request-basic-and-code` | must-redact | partial | redacted |
