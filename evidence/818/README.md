# Evidence: redact-secret#818 — fixed-candidate rerun of its beta9-external-inputs fixtures
...
Gap: [redact-secret#818](https://github.com/redact-secret/redact-secret/issues/818),
...
| --- | --- | --- | --- |
| `beta9-external-inputs--rfc7617-basic-utf8-proxy` | must-redact | missed | redacted |
| `beta9-external-inputs--composed-curl-single-quoted-json` | must-redact | partial | redacted |
| `beta9-external-inputs--composed-zero-width-inside-bearer` | must-redact | missed | redacted |
