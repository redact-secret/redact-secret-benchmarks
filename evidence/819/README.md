# Evidence: redact-secret#819 — fixed-candidate rerun of its beta9-external-inputs fixtures

**Result:** PASS. On the fixed candidate `192c964` all 3 of this gap's
...
Gap: [redact-secret#819](https://github.com/redact-secret/redact-secret/issues/819),
...
| --- | --- | --- | --- |
| `beta9-external-inputs--rfc8959-secret-token-folded-bearer` | must-redact | partial | redacted |
| `beta9-external-inputs--rfc8959-secret-token-prose` | must-redact | partial | redacted |
| `beta9-external-inputs--composed-secret-token-uppercase-scheme` | must-redact | missed | redacted |
