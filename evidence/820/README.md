# Evidence: redact-secret#820 — fixed-candidate rerun of its beta9-external-inputs fixtures
...
Gap: [redact-secret#820](https://github.com/redact-secret/redact-secret/issues/820),
...
| --- | --- | --- | --- |
| `beta9-external-inputs--composed-userinfo-password-url` | must-redact | missed | redacted |
